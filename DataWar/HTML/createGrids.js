...
var advancedTexture2,width_map,height_map;
//绘制整体化的gui用来表示单元格的索引
function initText()
{
    ...
    var mesh_floor_text=BABYLON.MeshBuilder.CreatePlane("mesh_floor_text",{width:width_map
        ,height:height_map},scene);
    mesh_floor_text.rotation.x=Math.PI/2;
    mesh_floor_text.position=new BABYLON.Vector3(width_map/2,3,-height_map/2);
