...
newland.CreateCubeArenaWithPhy3=function(obj_p)
{
    ...
    if(true)
    {
        ...
        var mesh_oz2=new BABYLON.MeshBuilder.CreateBox("mesh_oz2"//显示为一个平面，但物理外套是一个扁平的盒子
        ...
        mesh_oz2.isVisible=flag_seeimp;
        ...
        mesh_ox2.isVisible=flag_seeimp;
        ...
        mesh_oy2.isVisible=flag_seeimp;
...
newland.requestAnimFrame = (function() {//在这里调用会报错
